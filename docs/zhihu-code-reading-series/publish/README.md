...
当前体量约 **10000+ 行** 正文（核心十篇约 900–1100 行，另含 EP 独立专题），在提纲导读之上补充了：
...
| 09 | [09-moe.md](./09-moe.md) | MoE 完全精读——Router、Dispatcher、负载均衡 | ~910 |
| 10 | [10-advanced.md](./10-advanced.md) | 从「读通主路径」到「能改框架」 | ~910 |
| 11 | [11-expert-parallel.md](./11-expert-parallel.md) | 专家并行 EP 完全指南——切分、Token 迁移与进程组 | ~650 |

**读 MoE 前若对 EP 发懵**：建议顺序 `04 → 11 → 09`。
